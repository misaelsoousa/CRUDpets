        ...
        <div class="container-fluid">
            <div class="row">
                <div style="width: 250px;">
                    <img src="/img_admin/kbrtec.webp" alt="KBRTEC" height="60" width="150" class="object-fit-contain">
                </div>
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
        <aside class="bg-custom text-light py-4" style="width: 250px;">
            <div class="menu">
                ...
                <a href="{{route('login.form')}}" class="w-100 d-flex align-items-center gap-2 link-light text-decoration-none mt-2 py-3 px-3 ms-1 icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(-.125rem, 0, 0);">
