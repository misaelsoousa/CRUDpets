            ...
            <div class="row align-items-center">
                <div class="col-4">
                    <a href="{{route('home')}}" title="KBR TEC" class="d-inline-block">
                        <h1>
                            <img src="img_pet/logo.webp" alt="KBR TEC" width="150">
                        </h1>
                    </a>
                </div>
    ...
    <nav aria-label="breadcrumb" class="p-3 bg-custom-light">
        <div class="container">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item fs-sm"><a href="{{route('adotar')}}">Tini</a></li>
    ...
    <section class="bg-light py-5">
        <div class="container mb-5">
            ...
            <form action="{{route('formulario-store')}}" method="POST" class="bg-custom rounded p-4 mt-4 col-6 mx-auto row">
                ...
                <input type="hidden" name="idPet" id="idPet" value="{{ request('idPet') }}">
    ...
    <section class="bg-custom py-3" style="background-color: #FFECCE;">
        <div class="container">
            <div class="d-flex align-items-center justify-content-center gap-3">
                ...
                <img src="img_pet/cartoon-cat-3.webp" alt="Gato" width="150">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="https://www.kbrtec.com.br/" target="_blank" title="Acesse o site da KBR TEC">
                    <img src="img_pet/kbrtec.webp" alt="KBRTEC" width="100">
                </a>
            </div>
        </div>
    </footer>
